...
function Homepage() {
  return (
    <>
      ...
      <div className="max-w-5xl mx-auto px-4 py-16 mb-12 text-center">
        ...
        <div className="flex flex-col md:flex-row text-red-600 font-bold justify-center md:gap-40 gap-10 mt-[100px]">
